"""PipetteTipBoxDescriptor & PipetteTipBoxDescription v4
...
class PipetteTipBoxDescription(BaseLabwareDescriptionV2):
...
class PipetteTipBoxDescriptor(BaseLabwareDescriptorV2):
