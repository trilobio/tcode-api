...
def migrate_v1_to_v2(data: RawData) -> RawData:
    """Migrate a TubeHolderDescription or TubeHolderDescriptor from schema version 1 to 2."""
...
def migrate_v2_to_v3(data: RawData) -> RawData:
    """Migrate a TubeHolderDescription or TubeHolderDescriptor from schema version 2 to 3."""
