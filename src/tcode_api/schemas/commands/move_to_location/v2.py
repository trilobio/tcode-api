...
class MOVE_TO_LOCATION_V2(BaseRobotSpecificTCodeCommand):
    ...
    speed: ValueWithUnits | None = Field(
        default=None,
        description="Optional speed override applied only to this movement.",
    )
